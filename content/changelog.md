...
```text
0.1.0    Initial commit: Hugo…
│
├─ 0.2.0    新文章: Windows 服务精简记录
│
├─ 0.3.0    重构文章为 Page Bundle 格式…
│
└─ 0.4.0    新增 Agent 工作日志专区（日期纵深…
   │
   ├── 0.4.1    新增更新日志板块 v0.1→v0.4 记录
   ├── 0.4.2    站点改名回顾笔记 + SEO 优化
   ├── 0.4.3    新增自动更新日志生成脚本，基于 git …
   └── 0.4.4    完善更新日志：每个 commit 附带详…
```
...
- `0036dec` 2026-07-02 — 完善更新日志：每个 commit 附带详细变更说明 `v0.4.4`
